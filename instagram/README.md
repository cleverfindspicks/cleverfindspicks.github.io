...
6. Permissions: `instagram_business_basic`, `instagram_business_content_publish`, and `instagram_business_manage_insights` for official analytics. No message, comments, Page or ads permissions. While the app is in development, add and accept the account's authorised app/tester role. Follow any access review Meta requires in your dashboard.
