...
export async function exportHub(db){
  ...
  const safe=rows.map(r=>({instagramPublicationId:r.instagram_publication_id,trackingId:r.internal_instagram_tracking_id,productId:r.product_id,productSlug:r.product_slug,creativeId:r.creative_id,publishedAt:r.published_at,mediaId:r.media_id,permalink:r.permalink,hook:r.hook}));
