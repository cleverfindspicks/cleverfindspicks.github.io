...
products.push({
  ...
  pinterestMediaType: bundle.candidate.pinCreative?.mediaType || 'IMAGE',
  pinterestVideoSourceType: bundle.candidate.pinCreative?.videoSourceType || null,
  pinterestPlatform: 'pinterest',
