...
const validBundle = validatePublicationBundle({ candidate: strong, verification: { productId: strong.productId }, landingPage: { slug: 'example', title: 'Example', summary: 'Summary' }, rssItem: { title: 'Example', link: 'https://cleverfindspicks.github.io/finds/example', image: '/pin.png' } });
