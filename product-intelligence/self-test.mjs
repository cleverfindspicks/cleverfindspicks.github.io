...
const strong = {
  ...
  pinCreative: { path: 'public/pinterest/example-pin.png', width: 1000, height: 1500, reviewedNonClickbait: true, renderer: 'PinterestCreativeRenderer', platform: 'pinterest', format: 'static-2:3', layoutFamily: 'pinterest-editorial-v3', videoFrameStyling: false, rawProductImageAsPin: false, sourceProductId: '1005000000000001', sourceImageSha256: 'a'.repeat(64), productAreaRatio: 0.535, visibleText: ['CLEVER FINDS', 'Make sink space work', 'Keep essentials within reach'] },
};
